...
async def command_start(message: Message, bot: Bot):
    ...
    await message.answer(
        """Здравствуйте. Это бот с веб-справочником.
Чтобы открыть веб-страницу справочника наберите эту команду /webview и нажмите на кнопку под отправленным сообщением.
Для дополнительных команд наберите команду /help.""")
